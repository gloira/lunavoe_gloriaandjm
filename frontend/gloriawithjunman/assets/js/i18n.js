window.I18N = {
  en: {
    ...
    home_intro_body:
      "Think of this as a small holiday with people we love. Arrive on Friday, settle into your villa or hotel, and ease into Bali time before the wedding on Saturday afternoon.",
    home_highlight_1:
      "Ceremony at Stone Villas Uluwatu overlooking the Indian Ocean.",
    home_highlight_2:
    ...
    dresscode_subtitle: "Formal / Semi-Formal � Daytime Ceremony",
    dresscode_intro:
    ...
    dresscode_gents_caption_1: "Gentlemen Look 1",
    dresscode_gents_caption_2: "Gentlemen Look 2",
    dresscode_gents_caption_3: "Gentlemen Look 3",
    dresscode_gents_caption_4: "Gentlemen Look 4",
    dresscode_gents_caption_5: "Gentlemen Look 5",
    dresscode_gents_caption_6: "Gentlemen Look 6",
    dresscode_gents_caption_7: "Gentlemen Look 7",
    dresscode_gents_caption_8: "Gentlemen Look 8",
    dresscode_gents_caption_9: "Gentlemen Look 9",
    dresscode_gents_caption_10: "Gentlemen Look 10",
    dresscode_gents_caption_11: "Gentlemen Look 11",
    dresscode_gents_caption_12: "Gentlemen Look 12",
    dresscode_gents_caption_13: "Gentlemen Look 13",
    dresscode_gents_caption_14: "Gentlemen Look 14",
  ...
  zh: {
    ...
    hero_copy:
      "邀请你在乌鲁瓦图的悬崖海边与我们共度悠闲周末：誓言、日落鸡尾酒，以及星空下的舞会。",
    hero_cta_primary: "出席回复",
    hero_cta_secondary: "周末详情",
    scroll_hint: "向下滑动",
    home_intro_title: "巴厘岛的悠长周末",
    home_intro_body:
      "把这次当成和我们一起的小旅行。周五抵达，入住别墅或酒店，周六下午婚礼开始前先慢慢进入巴厘岛节奏。",
    home_highlight_1:
      "仪式在 Stone Villas Uluwatu 举行，可俯瞰印度洋。",
    home_highlight_2:
      "慢节奏的早晨、海景咖啡，以及巴厘岛的小冒险。",
    home_highlight_3:
      "周日不设固定行程——睡个懒觉、早午餐或继续旅行。",
    home_story_title: "我们的故事",
    home_story_body: "一些我们的旅程片段。",
    schedule_title: "周末日程",
    schedule_intro:
      "我们把安排保持轻松，留出充足时间享受巴厘岛。",
    schedule_fri_label: "周五 · 抵达",
    ...
    dresscode_intro:
      "????????????,????????<strong>??????</strong>,???????????????",
    dresscode_ladies_title: "??",
    dresscode_ladies_body:
      "???????????????????????,???????????",
    dresscode_ladies_palette_label: "????(?????):",
    dresscode_ladies_neutral_label:
      "??????:?????????????????",
    dresscode_ladies_avoid:
      "?????????????????????????",
    dresscode_gents_title: "??",
    dresscode_gents_body: "??????????,??????",
    dresscode_gents_options_label: "??????:",
    dresscode_gents_option_1: "????????",
    dresscode_gents_option_2:
      "??????????? Polo(? / ? / ?? / ??)",
    dresscode_gents_option_3:
      "?? / ?? / ?? / ?????(????????)",
    dresscode_gents_color_note:
      "????(??):??????? / ??? / ???????? Polo ?????,??????????",
    dresscode_avoid_title: "???(??)",
    dresscode_avoid_note: "???????,????????????,??:",
    dresscode_avoid_item_1: "T ? / ??",
    dresscode_avoid_item_2: "??",
    dresscode_avoid_item_3: "??? / ????",
    dresscode_avoid_item_4: "??? / ?????????",
    dresscode_avoid_item_5: "??? / ??????",
    dresscode_thanks: "??????????????,??????!",
    dresscode_caption_soft_blush: "??",
    dresscode_caption_dusty_rose: "????",
    dresscode_caption_soft_pink: "??",
    dresscode_caption_blush_pink: "??",
    dresscode_caption_dusty_blush: "???",
    dresscode_caption_rose_pink: "???",
    dresscode_caption_muted_blush: "???",
    dresscode_caption_dusty_pink: "??",
    dresscode_caption_butter_yellow: "???",
    dresscode_caption_champagne_yellow: "???",
    dresscode_caption_golden_sand: "??",
    dresscode_caption_sunflower_yellow: "????",
    dresscode_caption_marigold: "????",
    dresscode_caption_honey_gold: "???",
    dresscode_caption_warm_ochre: "???",
    dresscode_caption_lemon_cream: "????",
    dresscode_caption_soft_gold: "??",
    dresscode_caption_soft_neutral: "????",
    dresscode_caption_sand_beige: "???",
    dresscode_caption_warm_stone: "???",
    dresscode_caption_taupe: "???",
    dresscode_caption_champagne_beige: "???",
    dresscode_caption_warm_ivory: "???",
    dresscode_gents_caption_1: "???? 1",
    dresscode_gents_caption_2: "???? 2",
    dresscode_gents_caption_3: "???? 3",
    dresscode_gents_caption_4: "???? 4",
    dresscode_gents_caption_5: "???? 5",
    dresscode_gents_caption_6: "???? 6",
    dresscode_gents_caption_7: "???? 7",
    dresscode_gents_caption_8: "???? 8",
    dresscode_gents_caption_9: "???? 9",
    dresscode_gents_caption_10: "???? 10",
    dresscode_gents_caption_11: "???? 11",
    dresscode_gents_caption_12: "???? 12",
    dresscode_gents_caption_13: "???? 13",
    dresscode_gents_caption_14: "???? 14",
